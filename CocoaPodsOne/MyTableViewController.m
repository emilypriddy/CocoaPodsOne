...
@interface MyTableViewController () <DNSSwipeableCellDelegate, DNSSwipeableCellDataSource>
...
- (void)viewDidLoad
{
    ...
    // Create and array of image names
...
//{
//    // List of fonts available for iOS 7: http://support.apple.com/kb/HT5878
...
- (void)showDetailForIndexPath:(NSIndexPath *)indexPath fromDelegateButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    if (buttonIndex == -1) {
        ...
        // Set up nav controller to contain the detail vc.
        UINavigationController *navController = [[UINavigationController alloc] initWithRootViewController:detail];
        
        // Set up button to close the detail VC (will call the method below).
